...
<div style="background: #F8F8F8; min-height: 520px; margin-top: -10px">
   <div class="container">
      <div class="row">
         ...
         <div class="col-lg-9" style="min-height: 100px;  border: 1px solid #e0e0e0; background: white; margin-left: 10px;margin-bottom: 10px; margin-top: 10px">
               ...
               <div class="col-md-12">
                  ...
                  <form action="{{ url('profile/edit') }}" method="post">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                           <input type="text" class="form-control" id="birth_day" name="birth" placeholder="Birth Day" value="{{ $user->birth_day }}">
                        </div>
                     </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                           <input type="text" class="form-control" id="phone" name="phone" placeholder="Birth Day" value="{{ $user->phone }}">
                        </div>
                     </div>
