               ...
               <div class="my-account-section" style="padding: 0 30px 20px;">
                  ...
                  <div class="my-account-section__header">
                     <div class="my-account-section__header-left">
                        <div class="my-account-section__header-title" style="float: left;">
                            <img src="{{ $vendor->logo }}" width="100px" height="50px" style="border-radius: 50%">
                            Vendor {{ $vendor->full_name }}
                          </div>
                        <a href='{{ url($vendor->nickname.'/product-add') }}' class="btn btn-primary" id="add" style="float: right; cursor: pointer;">+ TAMBAH PRODUCT</a>
                     </div>
                  </div>
                  ...
                  <div class="row container_content mt-10">
                     <div class="col-md-12">
                        ...
                        <div class="row">
                          <label for="staticEmail" class="col-sm-2 col-form-label">Motto</label>
                          <div class="col-sm-10 text_profile">
                            {{ $vendor->motto }}
                          </div>
                        </div>
