         ...
         <div class="row" style="min-height: 400px;" >
            <div class="col-lg-12 container-body-add-proudct">
              ...
              @if(Session::has('error_message'))
               ...
               <h3 class="header-container-add-product">Edit Barang</h3>
               @csrf
         ...
         <div class="row">
            <div class="col-lg-12 container-body-add-proudct">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                     <input type="text" class="form-control format-nominal" name="minimum_deposit" id="minimum_deposit" value="{{ $product->minimum_deposit }}">
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-lg-12 container-body-add-proudct">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                     <input type="number" min="0" name="weight" id="weight" class="form-control" value="{{ $product->weight }}">
                  </div>
               </div>
               <div class="form-group row">
